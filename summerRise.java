...
public class summerRise {
  ...
  txt = txt.replace("(", "");
	...
	try {
		...
		//s+=inputLine.replaceAll(new String("â".getBytes("UTF-8"), "UTF-8"), "'").replaceAll(new String("Â".getBytes("UTF-8"), "UTF-8"), "\"").replaceAll("[\u2018\u2019\u201A\u201B\u2032\u2035]", "'")
		// .replaceAll("[\u201C\u201D\u201E\u201F\u2033\u2036]", "\"");
		s+=inputLine;//.replaceAll("â", "'").replaceAll("Â", "\"");//.replaceAll("[\u2018\u2019\u201A\u201B\u2032\u2035]", "'")
		    //.replaceAll("[\u201C\u201D\u201E\u201F\u2033\u2036]", "\"");
	    }
	    in.close();
